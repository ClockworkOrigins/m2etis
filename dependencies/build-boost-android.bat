...
echo "Building Boost"
b2 toolset=gcc-android target-os=linux --with-serialization --with-system link=static threading=multi --layout=system -j %NUMBER_OF_PROCESSORS% variant=release install --prefix=%PREFIX% stage
