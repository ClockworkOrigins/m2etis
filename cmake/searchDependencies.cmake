...
IF(WIN32 AND NOT ANDROID AND NOT EXISTS "${M2ETIS_DEP_DIR}/boost/")
...
ENDIF(WIN32 AND NOT ANDROID AND NOT EXISTS "${M2ETIS_DEP_DIR}/boost/")
IF(CMAKE_HOST_WIN32 AND ANDROID AND NOT EXISTS "${M2ETIS_DEP_DIR}/boost/")
...
ENDIF(CMAKE_HOST_WIN32 AND ANDROID AND NOT EXISTS "${M2ETIS_DEP_DIR}/boost/")
IF(UNIX AND NOT ANDROID AND NOT EXISTS "${M2ETIS_DEP_DIR}/boost/")
...
ENDIF(UNIX AND NOT ANDROID AND NOT EXISTS "${M2ETIS_DEP_DIR}/boost/")
IF(UNIX AND ANDROID AND NOT CMAKE_HOST_WIN32 AND NOT EXISTS "${M2ETIS_DEP_DIR}/boost/")
...
ENDIF(UNIX AND ANDROID AND NOT CMAKE_HOST_WIN32 AND NOT EXISTS "${M2ETIS_DEP_DIR}/boost/")
SET(LIBNAME "BOOST")
...
IF(WIN32 AND NOT ANDROID AND NOT EXISTS "${M2ETIS_DEP_DIR}/clockUtils/")
...
ENDIF(WIN32 AND NOT ANDROID AND NOT EXISTS "${M2ETIS_DEP_DIR}/clockUtils/")
IF(CMAKE_HOST_WIN32 AND ANDROID AND NOT EXISTS "${M2ETIS_DEP_DIR}/clockUtils/")
...
ENDIF(CMAKE_HOST_WIN32 AND ANDROID AND NOT EXISTS "${M2ETIS_DEP_DIR}/clockUtils/")
IF(UNIX AND NOT ANDROID AND NOT EXISTS "${M2ETIS_DEP_DIR}/clockUtils/")
...
ENDIF(UNIX AND NOT ANDROID AND NOT EXISTS "${M2ETIS_DEP_DIR}/clockUtils/")
IF(UNIX AND ANDROID AND NOT CMAKE_HOST_WIN32 AND NOT EXISTS "${M2ETIS_DEP_DIR}/clockUtils/")
...
ENDIF(UNIX AND ANDROID AND NOT CMAKE_HOST_WIN32 AND NOT EXISTS "${M2ETIS_DEP_DIR}/clockUtils/")
...
IF(WITH_LOGGING)
	IF(WIN32 AND NOT ANDROID AND NOT EXISTS "${M2ETIS_DEP_DIR}/glog/")
	...
	ENDIF(WIN32 AND NOT ANDROID AND NOT EXISTS "${M2ETIS_DEP_DIR}/glog/")
	IF(UNIX AND NOT ANDROID AND NOT EXISTS "${M2ETIS_DEP_DIR}/glog/")
	...
	ENDIF(UNIX AND NOT ANDROID AND NOT EXISTS "${M2ETIS_DEP_DIR}/glog/")
	SET(LIBNAME "GLOG")
...
IF(WITH_TESTING)
	IF(WIN32 AND NOT ANDROID AND NOT EXISTS "${M2ETIS_DEP_DIR}/gmock/")
	...
	ENDIF(WIN32 AND NOT ANDROID AND NOT EXISTS "${M2ETIS_DEP_DIR}/gmock/")
	IF(UNIX AND NOT ANDROID AND NOT EXISTS "${M2ETIS_DEP_DIR}/gmock/")
	...
	ENDIF(UNIX AND NOT ANDROID AND NOT EXISTS "${M2ETIS_DEP_DIR}/gmock/")
	SET(LIBNAME "GTEST")
