...
#ifndef __M2ETIS_PUBSUB_FILTER_FILTEREXPRESSIONS_GREATERTHANATTRIBUTEFILTER_H__
#define __M2ETIS_PUBSUB_FILTER_FILTEREXPRESSIONS_GREATERTHANATTRIBUTEFILTER_H__
...
namespace filter {
	...
	public:
		...
		GreaterThanAttributeFilter() : AttributeFilter<EventType, AttributeType>(-1, {}) {} // needed for boost serialization
		GreaterThanAttributeFilter(const AttributeName attribute_id, const AttributeType & constants) : AttributeFilter<EventType, AttributeType>(attribute_id, {constants}) {}
...
#endif /* __M2ETIS_PUBSUB_FILTER_FILTEREXPRESSIONS_GREATERTHANATTRIBUTEFILTER_H__ */
