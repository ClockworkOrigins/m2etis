...
typedef Channel<
    ...
    net::NetworkType<net::TCP>,
    CharVectorEventType
> TEST_DirectBroadcast_Null_GMS_Null_Null_Null_Null_Null_CharVector_TCPType;

template <>
struct ChannelT<TEST_DirectBroadcast_Null_GMS_Null_Null_Null_Null_Null_CharVector_TCP>{
    ChannelT(const std::string & ip, const unsigned short port, const std::string & known_hostname, const unsigned short known_hostport, PubSubSystemEnvironment * pssi, std::vector<ChannelEventInterface *> & map, const std::vector<std::string> & rootList)
    {
        map.push_back(new TEST_DirectBroadcast_Null_GMS_Null_Null_Null_Null_Null_CharVector_TCPType( TEST_DirectBroadcast_Null_GMS_Null_Null_Null_Null_Null_CharVector_TCP, ip, port, known_hostname, known_hostport, pssi, rootList));
    }
};
...
typedef Channel<
    ...
    net::NetworkType<net::UDP>,
    CharVectorEventType
> TEST_DirectBroadcast_Null_GMS_Null_Null_Null_Null_Null_CharVector_UDPType;

template <>
struct ChannelT<TEST_DirectBroadcast_Null_GMS_Null_Null_Null_Null_Null_CharVector_UDP>{
    ChannelT(const std::string & ip, const unsigned short port, const std::string & known_hostname, const unsigned short known_hostport, PubSubSystemEnvironment * pssi, std::vector<ChannelEventInterface *> & map, const std::vector<std::string> & rootList)
    {
        map.push_back(new TEST_DirectBroadcast_Null_GMS_Null_Null_Null_Null_Null_CharVector_UDPType( TEST_DirectBroadcast_Null_GMS_Null_Null_Null_Null_Null_CharVector_UDP, ip, port, known_hostname, known_hostport, pssi, rootList));
    }
};
...
typedef Channel<
    ...
    net::NetworkType<net::TCP>,
    CharVectorEventType
> TEST_DirectBroadcast_Null_GMS_Null_Null_Null_BruteForce_Null_CharVector_TCPType;

template <>
struct ChannelT<TEST_DirectBroadcast_Null_GMS_Null_Null_Null_BruteForce_Null_CharVector_TCP>{
    ChannelT(const std::string & ip, const unsigned short port, const std::string & known_hostname, const unsigned short known_hostport, PubSubSystemEnvironment * pssi, std::vector<ChannelEventInterface *> & map, const std::vector<std::string> & rootList)
    {
        map.push_back(new TEST_DirectBroadcast_Null_GMS_Null_Null_Null_BruteForce_Null_CharVector_TCPType( TEST_DirectBroadcast_Null_GMS_Null_Null_Null_BruteForce_Null_CharVector_TCP, ip, port, known_hostname, known_hostport, pssi, rootList));
    }
};
...
typedef Channel<
    ...
    net::NetworkType<net::UDP>,
    CharVectorEventType
> TEST_DirectBroadcast_Null_GMS_Null_Null_Null_BruteForce_Null_CharVector_UDPType;

template <>
struct ChannelT<TEST_DirectBroadcast_Null_GMS_Null_Null_Null_BruteForce_Null_CharVector_UDP>{
    ChannelT(const std::string & ip, const unsigned short port, const std::string & known_hostname, const unsigned short known_hostport, PubSubSystemEnvironment * pssi, std::vector<ChannelEventInterface *> & map, const std::vector<std::string> & rootList)
    {
        map.push_back(new TEST_DirectBroadcast_Null_GMS_Null_Null_Null_BruteForce_Null_CharVector_UDPType( TEST_DirectBroadcast_Null_GMS_Null_Null_Null_BruteForce_Null_CharVector_UDP, ip, port, known_hostname, known_hostport, pssi, rootList));
    }
};
...
typedef Channel<
    ...
    net::NetworkType<net::TCP>,
    CharVectorEventType
> TEST_DirectBroadcast_BruteForce_GMS_Null_Null_Null_Null_Null_CharVector_TCPType;

template <>
struct ChannelT<TEST_DirectBroadcast_BruteForce_GMS_Null_Null_Null_Null_Null_CharVector_TCP>{
    ChannelT(const std::string & ip, const unsigned short port, const std::string & known_hostname, const unsigned short known_hostport, PubSubSystemEnvironment * pssi, std::vector<ChannelEventInterface *> & map, const std::vector<std::string> & rootList)
    {
        map.push_back(new TEST_DirectBroadcast_BruteForce_GMS_Null_Null_Null_Null_Null_CharVector_TCPType( TEST_DirectBroadcast_BruteForce_GMS_Null_Null_Null_Null_Null_CharVector_TCP, ip, port, known_hostname, known_hostport, pssi, rootList));
    }
};
...
typedef Channel<
    ...
    net::NetworkType<net::UDP>,
    CharVectorEventType
> TEST_DirectBroadcast_BruteForce_GMS_Null_Null_Null_Null_Null_CharVector_UDPType;

template <>
struct ChannelT<TEST_DirectBroadcast_BruteForce_GMS_Null_Null_Null_Null_Null_CharVector_UDP>{
    ChannelT(const std::string & ip, const unsigned short port, const std::string & known_hostname, const unsigned short known_hostport, PubSubSystemEnvironment * pssi, std::vector<ChannelEventInterface *> & map, const std::vector<std::string> & rootList)
    {
        map.push_back(new TEST_DirectBroadcast_BruteForce_GMS_Null_Null_Null_Null_Null_CharVector_UDPType( TEST_DirectBroadcast_BruteForce_GMS_Null_Null_Null_Null_Null_CharVector_UDP, ip, port, known_hostname, known_hostport, pssi, rootList));
    }
};
...
typedef Channel<
    ...
    net::NetworkType<net::TCP>,
    CharVectorEventType
> TEST_DirectBroadcast_BruteForce_GMS_Null_Null_Null_BruteForce_Null_CharVector_TCPType;

template <>
struct ChannelT<TEST_DirectBroadcast_BruteForce_GMS_Null_Null_Null_BruteForce_Null_CharVector_TCP>{
    ChannelT(const std::string & ip, const unsigned short port, const std::string & known_hostname, const unsigned short known_hostport, PubSubSystemEnvironment * pssi, std::vector<ChannelEventInterface *> & map, const std::vector<std::string> & rootList)
    {
        map.push_back(new TEST_DirectBroadcast_BruteForce_GMS_Null_Null_Null_BruteForce_Null_CharVector_TCPType( TEST_DirectBroadcast_BruteForce_GMS_Null_Null_Null_BruteForce_Null_CharVector_TCP, ip, port, known_hostname, known_hostport, pssi, rootList));
    }
};
...
typedef Channel<
    ...
    net::NetworkType<net::UDP>,
    CharVectorEventType
> TEST_DirectBroadcast_BruteForce_GMS_Null_Null_Null_BruteForce_Null_CharVector_UDPType;

template <>
struct ChannelT<TEST_DirectBroadcast_BruteForce_GMS_Null_Null_Null_BruteForce_Null_CharVector_UDP>{
    ChannelT(const std::string & ip, const unsigned short port, const std::string & known_hostname, const unsigned short known_hostport, PubSubSystemEnvironment * pssi, std::vector<ChannelEventInterface *> & map, const std::vector<std::string> & rootList)
    {
        map.push_back(new TEST_DirectBroadcast_BruteForce_GMS_Null_Null_Null_BruteForce_Null_CharVector_UDPType( TEST_DirectBroadcast_BruteForce_GMS_Null_Null_Null_BruteForce_Null_CharVector_UDP, ip, port, known_hostname, known_hostport, pssi, rootList));
    }
};
