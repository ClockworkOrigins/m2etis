message(STATUS "Own Boost Find Module with MSVC 10.0 support")
...
ELSE (_boost_IN_CACHE)
  ...
  IF(WIN32)
	  IF(CMAKE_CL_64)
	    MESSAGE(STATUS "Searching for x64 includes")
	    SET(_boost_INCLUDE_SEARCH_DIRS
	      "$ENV{ProgramFiles}/Boostx64/include"
	      /sw/local/include
	    )
	  ELSE(CMAKE_CL_64)
	    MESSAGE(STATUS "Searching for x86 includes")
	    SET(_boost_INCLUDE_SEARCH_DIRS
	      "$ENV{ProgramFiles}/Boostx86/include"
	      /sw/local/include
	    )
	  ENDIF(CMAKE_CL_64)
  ELSE(WIN32)
	    SET(_boost_LIBRARIES_SEARCH_DIRS
	      "${CMAKE_SOURCE_DIR}/dependencies/Boost_1_43/include"
	    )
  ENDIF(WIN32)
  ...
  IF(Boost_INCLUDE_DIR)
    ...
    SET(BOOST_PATH "${Boost_INCLUDE_DIR}/boost")
  ...
  IF (WIN32)
	  IF(CMAKE_CL_64)
	    MESSAGE(STATUS "Searching for x64 libraries")
	    SET(_boost_LIBRARIES_SEARCH_DIRS
	      "$ENV{ProgramFiles}/Boostx64/lib"
	      /sw/local/include
	    )
	  ELSE(CMAKE_CL_64)
	    MESSAGE(STATUS "Searching for x86 libraries")
	    SET(_boost_LIBRARIES_SEARCH_DIRS
	      "$ENV{ProgramFiles}/Boostx86/lib"
	      /sw/local/lib
	    )
	  ENDIF(CMAKE_CL_64)
  ELSE(WIN32)
	    SET(_boost_LIBRARIES_SEARCH_DIRS
	      "${CMAKE_SOURCE_DIR}/dependencies/Boost_1_43/lib"
	    )
  ENDIF(WIN32)
  IF( BOOST_ROOT )
    SET(_boost_LIBRARIES_SEARCH_DIRS 
